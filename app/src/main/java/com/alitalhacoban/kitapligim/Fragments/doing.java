                ...
                if (value != null) {
                    for (DocumentSnapshot snapshot : value.getDocuments()) {
                        ...
                        if (data != null) {
                            ...
                            // String downloaduri = data.get("downloadUri").toString();
                            ...
                            // String imageName = data.get("imageName").toString();
                    ...
                    countDoing = value.getDocuments().size();
